...
> **Mise en pratique** : Dans `mon-app`, modifiez le workflow CI pour tester sur Python 3.11 **et** 3.12 en parallèle. Configurez `fail-fast: false` pour toujours obtenir les résultats des deux versions même si l'une échoue.
