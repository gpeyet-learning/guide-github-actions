...
> **Mise en pratique** : Extrayez la logique de test de `mon-app` dans un reusable workflow nommé `reusable-python-tests.yml`. Ce workflow doit accepter en input la version Python et retourner en output le pourcentage de coverage. Le workflow principal `ci.yml` doit l'appeler.
